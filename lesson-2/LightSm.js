...
class LightSm
{
    ...
    #ON1_enter()
    {
        ...
        // ON1 behavior
        // uml: enter / { window.alert("ON. Count: " + this.vars.count); }
        {
            // Step 1: execute action `window.alert("ON. Count: " + this.vars.count);`
            window.alert("ON. Count: " + this.vars.count);
    ...
    #ON1_increase()
    {
        ...
        // ON1 behavior
        // uml: INCREASE / { this.vars.count++; } TransitionTo(ON1)
        {
            // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
            this.#ON1_exit();
            
            // Step 2: Transition action: `this.vars.count++;`.
            this.vars.count++;
