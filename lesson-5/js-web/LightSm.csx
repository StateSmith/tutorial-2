...
public class LightSmRenderConfig : IRenderConfigJavaScript
{
    ...
    bool IRenderConfigJavaScript.UseExportOnClass => false;
    ...
    {
        public string lightBlue()   => """outputText("BLUE")""";
        public string lightRed()    => $"""this.{AutoNameCopy()}()"""; // comes out as `this.lightRed()`.
    }
}
